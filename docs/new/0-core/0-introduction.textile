...
WebCore is a member of the "Marrow Project":marrow group of packages and is maintained by several core developers.  WebCore thus adheres to the "Python style guidelines":marrow-style, "development workflow":marrow-development, and "Zen":marrow-zen, as well as the "release cycle guidelines":marrow-release published by this group.
