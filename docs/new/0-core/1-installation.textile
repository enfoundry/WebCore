...
WebCore has been designed to require very few dependancies on its own; we feel that your application will know best what it needs.  Remember to manually install (or declare dependancies) for any additional packages you may require, such as a template engine.
...
"Prerequisites":#prerequisites:
    This section will step you through the installation of components required regardless of which installation method you choose.
"Installation using the Bootstrap Script":#bootstrap:
    The recommended method of installing WebCore, this will create a virtual environment then download and install WebCore and the framework dependancies.
"Manual Installation":#:
    These are installable Python packages, usually organized into a more formal model/view/controller structure.
"Manual Installation":#manual:
    You can also manage everything manually.  This section will additionally walk you through installation of the current development version of WebCore.
...
h2(#bootstrap). Installation using the Bootstrap Script
...
h2(#validate). Validate an Installation
